...
- **XMP metadata embedding** — Title and description from the JSON sidecar are embedded as Dublin Core XMP metadata, and creation date is embedded as `xmp:CreateDate`, into JPEG and MP4/MOV files.
